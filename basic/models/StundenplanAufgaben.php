 ...
 * @property int $U_ID
 */
class StundenplanAufgaben extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return StundenplanAufgabenQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StundenplanAufgabenQuery(get_called_class());
    }
